...
//  Netflix_Clone_App
//
//  Created by Abdulbosid Jalilov on 18/08/23.
//
...
class CollectionViewTableViewCell: UITableViewCell {
    ...
    private let collectionView: UICollectionView = {
        ...
        collectionView.register(TitleCollectionViewCell.self.self, forCellWithReuseIdentifier: TitleCollectionViewCell.identifier)
